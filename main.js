...
function addCounter() {
   const player1Span = document.getElementById('player1-pontuation')
   const player2Span = document.getElementById('player2-pontuation')
   let currentPlayer = document.getElementById('player1').value
   player1Span.innerText =  currentPlayer + " possui: " + player1Counter + "pontos"
   currentPlayer = document.getElementById('player2').value
   player2Span.innerText = currentPlayer + " possui: " + player2Counter + "pontos"
}
